 ...
 */
public class electro_parts extends Fragment {
    Context mContext;
    INodeJS myApi;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_electro_parts, container, false);
        //get data
        ...
        call.enqueue(new Callback<List<produit>>() {
            ...
            public void onResponse(Call<List<produit>> call, Response<List<produit>> response) {
                ...
                for(produit item:response.body()){
                    ...
                    PartsRV = view.findViewById(R.id.PartsItemsRVList);
